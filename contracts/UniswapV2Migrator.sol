...
contract UniswapV2Migrator is IUniswapV2Migrator {
    IUniswapV1Factory immutable FACTORY_V1;
    IUniswapV2Router01 immutable ROUTER;

    constructor(address _factoryV1, address _router) {
    FACTORY_V1 = IUniswapV1Factory(_factoryV1);
...
function migrate(address token, uint256 amountTokenMin, uint256 amountETHMin, address to, uint256 deadline)
        ...
        override
    {
        IUniswapV1Exchange exchangeV1 = IUniswapV1Exchange(FACTORY_V1.getExchange(token));
