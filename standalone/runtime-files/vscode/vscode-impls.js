...
// Ensure terminals tracking fields exist
if (!Array.isArray(vscode.window.terminals)) vscode.window.terminals = [];
if (!('activeTerminal' in vscode.window)) vscode.window.activeTerminal = undefined;
