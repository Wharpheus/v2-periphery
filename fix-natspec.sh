...
# Batch NatSpec and import fixer for Solidity files in contracts/ and agents/
find contracts/ agents/ -name "*.sol" | while read -r file; do
  ...
  # Replace global imports with named imports (optional, can be commented out if not needed)
